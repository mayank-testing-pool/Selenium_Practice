...
public class log4jConcept {
    ...
    public static void main(String[] args) {
        ...
        //To remove below Warnings define log4j property file as below
            //log4j:WARN No appenders could be found for logger
            //log4j:WARN Please initialize the log4j system properly.
        String log4jConfPath = "C:\\Users\\mm18780\\Desktop\\Mayank\\Automation\\Selenium_Practice\\resources\\log4j.properties";
        PropertyConfigurator.configure(log4jConfPath);
        // Store Logs in Selenium logs file
        //Logger log = Logger.getLogger(log4jConcept.class);
        // Store Logs in both Selenium and Manual logs file
